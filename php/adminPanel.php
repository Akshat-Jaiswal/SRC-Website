...
<div class="row">
  <div class="col-lg-2 left-sidebar box-gray">
            ...
            <ul class="nav nav-pills nav-stacked margintop20">
                <li class="active" ><a class="btn btn-navbar" href="#">Posts</a></li>
  ...
  <div class="content col-lg-9">
        ...
        <div class="container">
                ...
                <div class="box-gray col-lg-5" style="opacity:.8">
                    <h1 class="text-center "> Post A News</h1>
                ...
                <div class="box-gray col-lg-5" style="opacity:.8">
                    <h1 class="text-center "> Delete From DB</h1>
                    			 <form id="contactform2" action="php/Registration.php" method="POST" class="validateform" name="send-contact" enctype="multipart/form-data">
                                ...
                                <select id="table" class="form-control">
                                    ...
                                    <option value="aayaam">Aayaam Event</option>
                                ...
                                <p>    
                                    <button class="btn btn-blue margintop10 pull-left" type="button" onClick="uploadFile2()">Submit</button>
                                    <span class="pull-right margintop20">* Please fill all required form field, thanks!</span>
                                </p>
