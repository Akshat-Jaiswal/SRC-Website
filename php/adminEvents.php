...
<div class="row">
  <div class="col-lg-2 left-sidebar box-gray">
            ...
            <ul class="nav nav-pills nav-stacked margintop20">
                ...
                <li class="active"><a class="btn btn-navbar" href="#">Events</a></li>
  ...
  <div class="content col-lg-9">
        ...
        <div class="container" style="background-image:url(../images/Tulips.jpg); background-size:cover">
                ...
                <div class="box-gray col-lg-5" style="opacity:.8" >
                    <h1 class="text-center "> Add Events in Aayaam 2k15 </h1>
                    ...
                    <form id="contactform" action="php/Registration.php" method="POST" class="validateform" name="send-contact" enctype="multipart/form-data">
                            <div id="message">
                                ...
                                <input type="date" class="form-control" id="edate" placeholder=" yyyy-mm-dd" />
                                <div class="validation">
                                </div>
                                
                                <label >*Last Date of Registration </label>
                                <input type="date" class="form-control" id="ldate" placeholder=" yyyy-mm-dd" />
                                <div class="validation">
                                </div>
                                ...
                                <input type="file" class="form-control" id="statement" placeholder="" />
                                <div class="validation">
                                </div>
                                <label >*form link </label>
                                <input type="text" class="form-control" id="link" placeholder="paste your link here(<100 characters)" />
                                <div class="validation">
